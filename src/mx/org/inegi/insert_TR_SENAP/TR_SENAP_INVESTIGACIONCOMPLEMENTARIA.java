...
public class TR_SENAP_INVESTIGACIONCOMPLEMENTARIA {
    ...
    public void TR_SENAP_INVESTIGACIONCOMPLEMENTARIA(String Entidad, String Periodo) throws Exception {
        ...
        try {
            ...
            if (CFilas > 0) {
                sd = StructDescriptor.createDescriptor("RES_OBJ_TR_SENAP_INVESTIGACIONCOMPLEMENTARIA", con);
                ...
                descriptor = ArrayDescriptor.createDescriptor("RES_ARR_OBJ_TR_SENAP_INVESTIGACIONCOMPLEMENTARIA", con);
                System.out.println("entro 3");
                array_to_pass = new ARRAY(descriptor, con, structs);
                System.out.println("entro 4");
                st = con.prepareCall("{? = call(RES_PKG_INTEGRADOR_SENAP_BAK_TR.RES_TR_SENAP_INVESTIGACIONCOMPLEMENTARIA(?))}");
