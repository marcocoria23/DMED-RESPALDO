...
public class TMP_SENAP_MASC {
    ...
    public void TMP_SENAP_MASC(String Entidad, String Periodo) throws Exception {
        ...
        try {
            ...
            if (CFilas > 0) {
                sd = StructDescriptor.createDescriptor("RES_OBJ_TMP_SENAP_MASC", con);
                ...
                descriptor = ArrayDescriptor.createDescriptor("RES_ARR_OBJ_TMP_SENAP_MASC", con);
                System.out.println("entro 3");
                array_to_pass = new ARRAY(descriptor, con, structs);
                System.out.println("entro 4");
                st = con.prepareCall("{? = call(RES_PKG_INTEGRADOR_SENAP_BAK.RES_TMP_SENAP_MASC(?))}");
